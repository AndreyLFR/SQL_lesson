DROP DATABASE IF EXISTS hw_sem4;
CREATE DATABASE IF NOT EXISTS hw_sem4;
...
WHERE id NOT IN (
	SELECT shops_id
    FROM cats
    WHERE name_cats IN ('Murzik', 'Zuza')
);
